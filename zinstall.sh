...
sleep 1
sudo pacman -S --color=always --noconfirm --needed thunar feh dmenu git base-devel brightnessctl python-psutil acpi alsa-utils cbatticon network-manager-applet geeqie xcb-util-cursor xf86-video-intel xf86-video-nouveau exa gvfs ntfs-3g dunst scrot redshift bc unzip evince zsh xdg-utils 2> /dev/null
echo -e "${YE}Done${NC}"
