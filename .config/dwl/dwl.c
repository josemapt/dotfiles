...
{
	//-- options: device->name (char) ; device->vendor (int) ; device->product (int) --
	...
	if (wlr_input_device_is_libinput(device)) {
		...
		// Avoid mouse natural scrolling
		if (libinput_device_config_scroll_has_natural_scroll(libinput_device) && strstr(my_input_name, "Touchpad") != NULL){
			//printf("the device is %s", my_input_name);
